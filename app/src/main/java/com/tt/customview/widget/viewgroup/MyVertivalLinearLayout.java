package com.tt.customview.widget.viewgroup;
 ...
 */
public class MyVertivalLinearLayout extends ViewGroup {
    /**
     * 屏幕的高度
     */
    ...
    private MyVertivalLinearLayout.OnPageChangeListener mOnPageChangeListener;

    public MyVertivalLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public void setOnPageChangeListener(MyVertivalLinearLayout.OnPageChangeListener onPageChangeListener) {
